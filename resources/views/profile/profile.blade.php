            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="tanggal_lahir" type="date" min="1920-12-31" max="2050-12-31"
                                        ...
                                        name="tanggal_lahir" value="{{ auth()->user()->tanggal_lahir->format('Y-m-d') }}"
                                        required autocomplete="tanggal_lahir" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        @elseif (auth()->user()->jenis_kelamin == 'Perempuan')
                                            ...
                                            <label for="Laki-laki">Laki-laki</label>
                                            <input class="@error('jenis_kelamin') is-invalid @enderror ml-3" type="radio"
                                                id="Perempuan" name="jenis_kelamin" value="Perempuan" checked />
                                            <label for="Perempuan">Perempuan</label>
                                        @endif
                                    </div>
                                    @error('jenis_kelamin')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="kabupaten" class="form-control @error('regency_id') is-invalid @enderror"
                                        name="regency_id">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="desa" class="form-control @error('village_id') is-invalid @enderror"
                                        name="village_id">
                                        </option>
                    ...
                    <form method="post" action="/hapusakun/{{ auth()->user()->id }}">
                        ...
                        <button class="btn bg-gradient-dark w-100 my-4 mb-0 btndelete show_confirm" type="submit"
                            data-toggle="tooltip" title='Delete'>Hapus Akun Anda</button>
                    </form>
