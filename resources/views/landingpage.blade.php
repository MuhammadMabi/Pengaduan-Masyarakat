            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="" class="logo">
                            <img src="landingpage/assets/images/logo.png" alt="Chain App Dev">
                            {{-- <h4><em>Pengaduan Masyarakat</em></h4> --}}
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="service-item second-service">
                        ...
                        <p>Dalam 3 hari, petugas akan menindaklanjuti dan membalas laporan Anda</p>
                        <div class="text-button">
                            {{-- <a href="#">Read More <i class="fa fa-arrow-right"></i></a> --}}
                        </div>
                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="client-content">
                                                                <img src="landingpage/assets/images/quote.png"
                                                                    alt="">
                                                            ...
                                                            <div class="down-content">
                                                                <img src="landingpage/assets/images/client-image.jpg"
                                                                    alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="pricing-item-regular">
                        ...
                        <div class="icon">
                            <img src="landingpage/assets/images/pricing-table-01.png" alt="">
                        </div>
                        <ul>
